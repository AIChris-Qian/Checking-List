...
#### 9. [ 分类数据分析 ]
   `x^2 统计量 / 拟合优度检验 / 独立性检验 / 列联表的相关测量`


#### 10. [ 方差分析 ]
   `F 统计量 / 单因素方差分析 / 五交互作用的双因素方差分析 / 有交叉作用的双因素方差分析`
   

#### 11. [ 一元线性回归 ]
   `相关系数 / 回归直线的拟合优度 / 显著性检验 (线性关系 / 回归系数) / 利用回归方程进行预测 / 残差分析`
   

#### 12. [ 多元线性回归 ]
   `回归模型的拟合优度 / 显著性检验 (线性关系 / 回归系数) / 多重共线性 / 变量选择与逐步回归`
   

#### 13. [ 时间序列分析与预测 ]
   `平稳序列 / 非平稳序列 / 预测方法的评估 / 平稳序列的预测 / 趋势型序列的预测 / 复合型序列的分解预测`   
